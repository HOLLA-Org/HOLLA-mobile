...
import 'package:holla/feature/presentation/bloc/auth/verify/verify_event.dart';
import 'package:holla/feature/presentation/bloc/auth/verify/verify_state.dart';
...
class VerifyBloc extends Bloc<VerifyEvent, VerifyState> {
  ...
  Future<void> _onSubmitted(
    ...
    try {
      await _authRepository.verifyCode(email: event.email, code: event.code);
